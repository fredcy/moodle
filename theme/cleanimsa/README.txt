...
From your Moodle theme directory right click on cleanimsa and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of cleanimsa.
...
where the old theme name occurs, in this case cleanimsa. So using the above list as
a guide, search through and change all the instances of the theme name
'cleanimsa' to 'cleantheme'. This includes the filename of the lang/en/theme_cleanimsa.php.
You need to change this to 'theme_cleanimsatheme.php'.
